...
" Last Modifier: Ahn Ki-yung <kyagrd@bawi.org>
" Last Change:	2002-01-14
...
syn match hsImport		"\<import\>.*"he=s+6 contains=hsImportMod,hsVarSym,hsConSym
...
if exists("b:hs_literate_comments")
  syn region hsLiterateComment start="^" end="^>" contains=hsLiterateCodeBlock
  syn region hsLiterateCodeBlock start="begin{code}" end="end{code}" contains=hsVarSym,hsConSym,hsString,hsCharacter,hsNumber,hsFloat,hsModule,hsImport,hsImportMod,hsInfix,hsStructure,hsStructure,hsTypedef,hsStatement,hsConditional,hsBoolean,hsType,hsMaybe,hsExitCode,hsOrdering,hsDebug,hsLineComment,hsBlockComment,hsPragma
endif
